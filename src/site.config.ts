...
export const site = {
  ...
  description:
    'אתר תוכן מעמיק על קיסריה העתיקה — היסטוריה, ארכיאולוגיה, מבנים וסיפורים — מאת ד"ר יוחאי חלפון, מדריך שמכיר כל אבן במקום. הצטרפו לסיור מודרך והחזירו את העיר לחיים.',
  // פרטי קשר
  phone: '052-3003629',
